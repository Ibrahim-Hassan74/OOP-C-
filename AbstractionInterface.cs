...
namespace maincs.Models
{
    ...
    {
        public void Pay(decimal amount) => WriteLine($"Cash Payment: ${Round(amount, 2):N0}");
    }

    public class Debit : IPayment
    {
        public void Pay(decimal amount) => WriteLine($"Debit Payment: ${Round(amount, 2):N0}");
    }
    public class Mastercard : IPayment
    {
        public void Pay(decimal amount) => WriteLine($"Mastercard Payment: ${Round(amount, 2):N0}");
    }
    public class Via : IPayment
    {
        public void Pay(decimal amount) => WriteLine($"Via Payment: ${Round(amount, 2):N0}"); 
    }
}
